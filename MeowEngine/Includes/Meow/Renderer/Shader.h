...
namespace Meow
{
	...
	public:
		...
		virtual void setUniform1iv(const char* uniformName, int count, const int* value) = 0;
		virtual void setUniform1f(const char* uniformName, float value) = 0;
		virtual void setUniform1fv(const char* uniformName, int count, const float* value) = 0;
